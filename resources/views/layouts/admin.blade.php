        ...
        <div class="main-header">
            <div class="logo-header d-flex justify-content-center">
                <a href="" class="logo">
                    ...
                    <img src="{{ asset('user/img/brand.png') }}" alt="user-img" width="100">
                </a>
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        <li class="nav-item dropdown">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"
                                aria-expanded="false"> <img src="{{ asset('admin/img/profile.png') }}" alt="user-img"
                                    width="36"
                                    class="img-circle"><span>{{ Auth::guard('web')->user()->name }}</span></span> </a>
                            <ul class="dropdown-menu dropdown-user">
                                <li>
                                    <div class="user-box">
                                        <div class="u-img"><img src="{{ asset('admin/img/profile.png') }}"
                                                alt="user">
                                        </div>
                                        <div class="u-text">
